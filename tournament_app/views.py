...
@api_view(['GET','POST'])
def get_insert_team_data(request, tournamentid):

    if request.method =='GET':
        query = f"select get_insert_team_data('{tournamentid}');"
...
@api_view(['GET','POST'])
def check_tadmin_data(request, admindata):

    if request.method =='GET':
        query = f"select check_tadmin_data('{admindata}');"
