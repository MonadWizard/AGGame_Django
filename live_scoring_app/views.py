...
@api_view(['GET','POST'])
def get_batsman_aggrigation_data(request, matchid):

    if request.method =='GET':
        # data = matchid
        query = f"select get_batsman_aggrigation_data('{matchid}');"
...
@api_view(['GET','POST'])
def get_bowler_aggrigation_data(request, matchid):

    if request.method =='GET':
        # data = matchid
        query = f"select get_bowler_aggrigation_data('{matchid}');"
...
@api_view(['GET','POST'])
def get_fielding_aggrigation_data(request, matchid):

    if request.method =='GET':
        # data = matchid
        query = f"select get_fielding_aggrigation_data('{matchid}');"
...
@api_view(['GET','POST'])
def player_position_update(request):
    if request.method =='GET':
        return Response('get data')
        ...
        data = json.dumps(request.data)
        # print("data::::::::::::",data)
        query = f"select player_position_update('{data}');"
        # print("query::::::::::::",query)
...
@api_view(['GET','POST'])
def player_position_get(request, matchid):

    if request.method =='GET':
        # data = matchid
        query = f"select player_position_get('{matchid}');"
